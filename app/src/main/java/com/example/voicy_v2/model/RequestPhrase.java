...
public class RequestPhrase extends ServerRequest
{
    private static final String URL_REQUEST = "xxxxxx";
    private static final int ID_SERVER = 1;

    public RequestPhrase(Context context, CallbackServer callbackServer)
    {
